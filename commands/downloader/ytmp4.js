...
module.exports = {
  ...
  async execute({ sock, msg, from, args }) {
    ...
    try {
      ...
      let buffer, mimetype, title = 'video';
      try {
        ...
        if (parseInt(info.videoDetails.lengthSeconds) > 300)
          return sock.sendMessage(from, { text: '⏱️ Video too long (max 5 min).' }, { quoted: msg });
      ...
      return sock.sendMessage(from, { video: buffer, caption: `🎬 ${title}`, mimetype: mimetype || 'video/mp4' }, { quoted: msg });
    } catch (err) {
